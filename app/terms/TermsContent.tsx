...
import { DEFAULT_TERMS_HTML } from "../../lib/legal-defaults";
...
export function TermsContent() {
  ...
  useEffect(() => {
    ...
    getDoc(doc(db, "site_config", "content"))
      .then((snap) => {
        if (snap.exists()) {
          const date = snap.get("termsLastUpdated");
          const body = snap.get("termsHtml");
  ...
  useEffect(() => {
    ...
    const raw = html.trim() || DEFAULT_TERMS_HTML;
