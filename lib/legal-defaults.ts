/**
 * Default privacy and terms HTML for a standalone website.
 * Used on public pages and as initial value in admin edit modals.
 */

export const DEFAULT_PRIVACY_HTML = `<p>This page describes how we use your information when you use this site and any related services.</p>
<h2>Payment</h2>
...
<p>When you subscribe or sign up, we may receive your email address and other details you provide so we can manage your account and contact you about your membership or the service. We use this information only to provide and improve the service.</p>
<h2>Sharing</h2>
...
<p>Direct messages and other in-app communications are confidential. You must not copy, download, save, share, or use message content outside this service. Doing so violates our Terms of Service and may result in account termination and legal action. We process and store messages only to provide the messaging feature and as described in this policy.</p>
<h2>Changes</h2>
...
export const DEFAULT_TERMS_HTML = `<p>By using this site and any subscription or paid features, you agree to the following terms.</p>
<h2>Subscription</h2>
<p>If you subscribe, membership may be recurring (e.g. monthly). You will be charged each billing period until you cancel. You can cancel anytime via the link in your receipt email or the payment provider's customer portal.</p>
<h2>Access</h2>
<p>After payment, access is granted in accordance with the plan you chose. We will provide access within a reasonable time (e.g. within 24 hours) where applicable. Access is at our discretion and may be limited or revoked for abuse or violation of these terms.</p>
...
<h2>In-app messages — no sharing, copying, or use outside the app</h2>
<p>Direct messages and other in-app communications (“Messages”) between you and the service or its operators are confidential and intended for use only within this service. <strong>You may not copy, download, save, screenshot, record, share, distribute, republish, or use Messages—or any part of them—outside the app or for any purpose other than reading and replying within the service.</strong> This includes, but is not limited to: sharing on social media, messaging apps, or other platforms; saving to a device or cloud; using in another website, app, or product; using for commercial purposes; or training AI or other systems. Violation of this provision is a material breach of these terms and may result in immediate termination of access, forfeiture of fees, and legal action. We may report violations and pursue all available remedies, including injunctions and damages.</p>
